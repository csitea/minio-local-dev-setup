...
# Dependencies: 
# SUB_COMPONENT - the name fo the python subcomponent to install the modules for
# PRODUCT_DIR  - the root dir of the 
# do_check_install_poetry - a function to provision 
